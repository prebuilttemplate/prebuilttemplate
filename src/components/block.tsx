...
export default function Block({ showIcons = [1, 1, 1, 1], padding = "py-20 px-8" }: BlockProps) {
  ...
  return (
    <div className={baseClass}>
      <div className="bg-black border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2] max-w-4xl w-full mx-auto p-4 relative h-[30rem]">
